 ...
 */
public class DynamicObjectTypes extends HashMap implements DynamicObject
{
   ...
   static
   {
      ...
      attributes.put("birthdate",Date.class);
      attributes.put("ttl",Long.class);
      attributes.put("initial",Character.class);
      attributes.put("iq",Byte.class);
   }
}
